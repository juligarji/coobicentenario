...
// -------------------- variables de los 2 componentes ----------------
    ...
    var selectorCons = {
        max_ammount : 100000000,// en pesos
        min_ammount : 1300000,
    ...
    selectorCons.scope_max = selectorCons.max_ammount - 40000
    selectorCons.scope_min = selectorCons.min_ammount + 40000
    ...
    function paintPieValue(){
     ...
     function changeInput(){
        ...
        if(in_value < selectorCons.min_ammount){
            // es menor que otro
            alert('El valor ingresado debe ser mayor que $' + selectorCons.min_ammount)

...
// -------------------- variables de los 2 componentes ----------------
    ...
    var selectorCons = {
        ...
        in_color : "#336600",
        color_radius : 20,
        jump_money:200000 // valor del salto de la imagen como tal 
    }
    selectorCons.scope_max = selectorCons.max_ammount - 300000
    selectorCons.scope_min = selectorCons.min_ammount + 300000
